...
textfile = os.getcwd() + "/result_morning_batch_report.txt"
pdffile = os.getcwd() + "/Morning_batch_report.pdf"
textfile_remov_dups = os.getcwd() + "/result_morning_batch_report_dupsremoved.txt"

textfile = pathlib.Path(textfile)
pdffile = pathlib.Path(pdffile)
textfile_remov_dups = pathlib.Path(textfile_remov_dups)
